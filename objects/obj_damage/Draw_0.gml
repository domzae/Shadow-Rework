...
draw_outline_text(x-200,y+50,c_black,c_white,"DPS:")
...
if totalDPS < 100000
{
	draw_outline_text(x,y+50,c_black,c_white,string_thousands_scripts(totalDPS))
}
else
{
	draw_outline_text(x,y+50,c_black,c_white,string_abbrev_real(totalDPS,2))
}
